...
function wooCommerceMissingNottice($pluginConfig) { ?>
  <div class="error">
    <p><?php _e('Samba helper requires WooCommerce installed and activated.', 'elv-samba-helper'); ?></p>
  </div>
<?php }
...
function wooCommerceTooOldNottice($pluginConfig) { ?>
  <div class="error">
    <p><?php printf(
          __('Samba helper requires at least %s version of Woocommerce to run.', 'elv-samba-helper'),
